...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__material_min_css__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__material_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__material_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bbh_png__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bbh_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__bbh_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__uploader__ = __webpack_require__(9);
...
app.ports.uploadImage.subscribe(
	function(channelId) {
		Object(__WEBPACK_IMPORTED_MODULE_3__uploader__["a" /* uploadImage */])(channelId);
	}
);
...
module.exports = __webpack_require__.p + "assets/bbh.png";
...
function uploadImage(channelId) {
...
var _user$project$Models$initialModel = F2(
	function (route, mix) {
		return {mixes: _krisajenkins$remotedata$RemoteData$Loading, mix: mix, channels: _krisajenkins$remotedata$RemoteData$NotAsked, route: route, mdl: _debois$elm_mdl$Material$model, cardSize: 150, editPhotos: false};
	});
var _user$project$Models$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mixes: a, mix: b, channels: c, route: d, mdl: e, cardSize: f, editPhotos: g};
	});
var _user$project$Models$Channel = F3(
	function (a, b, c) {
		return {id: a, on: b, image: c};
	});
var _user$project$Models$Mix = function (a) {
	return {id: a};
};
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$MixRoute = function (a) {
	return {ctor: 'MixRoute', _0: a};
};
var _user$project$Models$MixesRoute = {ctor: 'MixesRoute'};

var _user$project$Msgs$UploadImage = function (a) {
	return {ctor: 'UploadImage', _0: a};
};
var _user$project$Msgs$OnSetChannel = function (a) {
	return {ctor: 'OnSetChannel', _0: a};
};
var _user$project$Msgs$SetChannel = function (a) {
	return {ctor: 'SetChannel', _0: a};
};
var _user$project$Msgs$OnMuteMix = function (a) {
	return {ctor: 'OnMuteMix', _0: a};
};
var _user$project$Msgs$MuteMix = function (a) {
	return {ctor: 'MuteMix', _0: a};
};
var _user$project$Msgs$OnFetchMixes = function (a) {
	return {ctor: 'OnFetchMixes', _0: a};
};
var _user$project$Msgs$OnFetchChannels = function (a) {
	return {ctor: 'OnFetchChannels', _0: a};
};
var _user$project$Msgs$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _user$project$Msgs$EditPhotos = {ctor: 'EditPhotos'};
var _user$project$Msgs$NavigateToUrl = function (a) {
	return {ctor: 'NavigateToUrl', _0: a};
};
...
var _user$project$Commands$channelDecoder = A3(
	...
	A3(
		...
		A3(
			...
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Channel))));
var _user$project$Commands$channelsDecoder = _elm_lang$core$Json_Decode$list(_user$project$Commands$channelDecoder);
var _user$project$Commands$fetchChannelsUrl = function (id) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'/api/mix/',
		_elm_lang$core$Basics$toString(id));
};
var _user$project$Commands$fetchChannels = function (id) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Msgs$OnFetchChannels,
			...
			_elm_lang$http$Http$request(
				{
					...
					url: _user$project$Commands$fetchChannelsUrl(id),
					body: _elm_lang$http$Http$emptyBody,
					expect: _elm_lang$http$Http$expectJson(_user$project$Commands$channelsDecoder),
					timeout: _elm_lang$core$Maybe$Nothing,
					withCredentials: false
				})));
};
var _user$project$Commands$mixesDecoder = _elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int);
var _user$project$Commands$fetchMixesUrl = '/api/mixes';
var _user$project$Commands$fetchMixes = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchMixes,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		_elm_lang$http$Http$request(
			{
				method: 'GET',
				...
				url: _user$project$Commands$fetchMixesUrl,
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Commands$mixesDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			})));
var _user$project$Commands$turnMixOff = function (id) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$OnMuteMix,
		_elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
...
var _user$project$Commands$turnOffChanUrl = F2(
	function (mix, chan) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'/api/channel/switch/',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(mix),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(chan),
						'/off'))));
	});
var _user$project$Commands$turnOnChanUrl = F2(
	function (mix, chan) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'/api/channel/switch/',
...
var _user$project$Commands$setChannel = F3(
	function (mix, chan, on) {
		var urlFn = on ? _user$project$Commands$turnOnChanUrl : _user$project$Commands$turnOffChanUrl;
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Msgs$OnSetChannel,
			_elm_lang$http$Http$request(
				{
					method: 'POST',
					headers: {
					...
					url: A2(urlFn, mix, chan),
					body: _elm_lang$http$Http$emptyBody,
					expect: _elm_lang$http$Http$expectStringResponse(
						function (_p1) {
							return _elm_lang$core$Result$Ok(
								{ctor: '_Tuple3', _0: mix, _1: chan, _2: on});
						}),
					timeout: _elm_lang$core$Maybe$Nothing,
					withCredentials: false
				}));
...
var _user$project$Router$mixesPath = '#mixes';
var _user$project$Router$mixPath = function (id) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Router$mixesPath,
		A2(
			_elm_lang$core$Basics_ops['++'],
			'/',
			_elm_lang$core$Basics$toString(id)));
};
var _user$project$Router$gotoMix = function (id) {
	return _user$project$Msgs$NavigateToUrl(
		_user$project$Router$mixPath(id));
};
var _user$project$Router$gotoMixes = _user$project$Msgs$NavigateToUrl(_user$project$Router$mixesPath);
var _user$project$Router$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$MixesRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$MixRoute,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('mixes'),
					_evancz$url_parser$UrlParser$int)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$MixesRoute,
					_evancz$url_parser$UrlParser$s('mixes')),
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Ports$uploadImage = _elm_lang$core$Native_Platform.outgoingPort(
	'uploadImage',
	function (v) {
		return v;
	});

var _user$project$Update$handleLocationChange = F2(
	function (location, model) {
		var newRoute = _user$project$Router$parseLocation(location);
		var cmds = function () {
			var _p0 = newRoute;
			if (_p0.ctor === 'MixRoute') {
				return {
					ctor: '::',
					_0: _user$project$Commands$fetchChannels(_p0._0),
					_1: {ctor: '[]'}
				};
			} else {
				return {ctor: '[]'};
		...
		var newMix = function () {
			var _p1 = newRoute;
			if (_p1.ctor === 'MixRoute') {
				return _elm_lang$core$Maybe$Just(_p1._0);
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		}();
		var newChannels = function () {
			var _p2 = newRoute;
			switch (_p2.ctor) {
				case 'MixesRoute':
					return _krisajenkins$remotedata$RemoteData$NotAsked;
		...
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				model,
				{route: newRoute, mix: newMix, channels: newChannels}),
			cmds);
	});
var _user$project$Update$updateCardSize = F2(
	function (code, model) {
		...
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				model,
				{cardSize: model.cardSize - howMuch}),
			{ctor: '[]'});
	});
var _user$project$Update$updateChannel = F3(
	function (id, on, chans) {
		var replaceChan = F2(
			function (chans, chan) {
				return A3(
					_elm_community$list_extra$List_Extra$replaceIf,
					function (ch) {
						return _elm_lang$core$Native_Utils.eq(ch.id, id);
					},
					chan,
					chans);
			});
...
var _user$project$Update$tryUpdateChannel = F4(
	function (mix, chan, on, model) {
		var newChans = function () {
			var _p4 = model.mix;
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p4._0, mix) ? A2(
					_krisajenkins$remotedata$RemoteData$map,
					A2(_user$project$Update$updateChannel, chan, on),
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Msgs$Mdl, _p5._0, model);
			case 'EditPhotos':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{editPhotos: !model.editPhotos}),
					{ctor: '[]'});
			case 'NavigateToUrl':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'MuteMix':
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Commands$turnMixOff(_p5._0),
						_1: {ctor: '[]'}
					});
			case 'SetChannel':
				return A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Commands$setChannel, _p5._0._0, _p5._0._1, _p5._0._2),
						_1: {ctor: '[]'}
					});
			case 'OnSetChannel':
				if (_p5._0.ctor === 'Ok') {
					return A4(_user$project$Update$tryUpdateChannel, _p5._0._0._0, _p5._0._0._1, _p5._0._0._2, model);
				} else {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_elm_lang$core$Debug$log, 'failed to set channel', model),
						{ctor: '[]'});
				}
			case 'OnFetchMixes':
				return A2(
							...
							mixes: A2(
								...
								function (ids) {
									return A2(
										_elm_lang$core$List$map,
										function (id) {
											return _user$project$Models$Mix(id);
										},
										ids);
								},
								_p5._0)
			...
			case 'OnFetchChannels':
				return A2(
					...
					{ctor: '[]'});
			case 'KeyMsg':
				return A2(_user$project$Update$updateCardSize, _p5._0, model);
			case 'OnLocationChange':
				return A2(_user$project$Update$handleLocationChange, _p5._0, model);
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _user$project$Ports$uploadImage(_p5._0),
						_1: {ctor: '[]'}
					});
		}
	});

var _user$project$Views_Mixes$mixCard = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p5 = _p2.cardSize;
		var _p3 = _p0;
		var _p4 = _p3.id;
		var title = A2(
			_elm_lang$core$Basics_ops['++'],
			'Mix ',
			_elm_lang$core$Basics$toString(_p4 + 1));
		return A2(
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(
									_user$project$Router$gotoMix(_p4)),
								_1: {ctor: '[]'}
							}
						}
					}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A5(
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onClick(
														_user$project$Msgs$MuteMix(_p4)),
													_1: {ctor: '[]'}
												}
											}
										}
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Mute all'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Views_Mixes$dashboard = F2(
	function (model, mixes) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Views_Mixes$mixCard(model),
						mixes)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Views_Mixes$maybeDashboard = function (model) {
	var _p6 = model.mixes;
	switch (_p6.ctor) {
		case 'NotAsked':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Not asked for mixes'),
					_1: {ctor: '[]'}
				});
		case 'Loading':
			return A2(
		...
		default:
			return A2(_user$project$Views_Mixes$dashboard, model, _p6._0);
	}
};
var _user$project$Views_Mixes$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Views_Mixes$maybeDashboard(model),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Views_Channels$chanCard = F3(
	function (_p1, mix, _p0) {
		var _p2 = _p1;
		var _p8 = _p2.cardSize;
		var _p3 = _p0;
		var _p7 = _p3.on;
		var _p6 = _p3.id;
		var name = A2(
			_elm_lang$core$Basics_ops['++'],
			'Ch ',
			_elm_lang$core$Basics$toString(_p6 + 1));
		var _p4 = function () {
			var _p5 = _p7;
			if (_p5 === true) {
				return {
					ctor: '_Tuple2',
					_0: 'On',
					_1: A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Teal, _debois$elm_mdl$Material_Color$A400)
				};
			} else {
				return {
					ctor: '_Tuple2',
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'url(\'',
									A2(_elm_lang$core$Basics_ops['++'], _p3.image, '\') center / cover'))),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(
									_user$project$Msgs$SetChannel(
										{ctor: '_Tuple3', _0: mix, _1: _p6, _2: !_p7})),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'background', 'rgba(0, 0, 0, 0.2)'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Views_Channels$dashboard = F3(
	function (model, chans, mix) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						A2(_user$project$Views_Channels$chanCard, model, mix),
						chans)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Views_Channels$maybeDashboard = function (_p9) {
	var _p10 = _p9;
	var _p11 = {ctor: '_Tuple2', _0: _p10.channels, _1: _p10.mix};
	switch (_p11._0.ctor) {
		case 'NotAsked':
			return A2(
				_elm_lang$html$Html$div,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Not asked for channels'),
					_1: {ctor: '[]'}
				});
		case 'Loading':
			return A2(
		...
		default:
			if (_p11._1.ctor === 'Nothing') {
				...
				return A3(_user$project$Views_Channels$dashboard, _p10, _p11._0._0, _p11._1._0);
			}
	}
};
var _user$project$Views_Channels$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_Grid$grid,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Views_Channels$maybeDashboard(model),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Views_ManageChannels$chanCard = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p5 = _p2.cardSize;
		var _p3 = _p0;
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(
									_user$project$Msgs$UploadImage(_p4)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Views_ManageChannels$dashboard = F2(
	function (model, chans) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Views_ManageChannels$chanCard(model),
						chans)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Views_ManageChannels$maybeDashboard = function (model) {
	var _p6 = model.channels;
	switch (_p6.ctor) {
		case 'NotAsked':
			return A2(
				_elm_lang$html$Html$div,
		...
		case 'Loading':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Loading channels...'),
					_1: {ctor: '[]'}
				});
		case 'Failure':
			return A2(
		...
		default:
			return A2(_user$project$Views_ManageChannels$dashboard, model, _p6._0);
	}
};
var _user$project$Views_ManageChannels$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_Grid$grid,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Hint: you can always use +/- keys to change button size'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$Views_ManageChannels$maybeDashboard(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$View$editPhotosNavidation = A2(
	_debois$elm_mdl$Material_Layout$link,
	{
		ctor: '::',
		_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Msgs$EditPhotos),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Edit photos'),
		_1: {ctor: '[]'}
	});
var _user$project$View$viewBody = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1;
	var _p2 = {ctor: '_Tuple2', _0: _p1.route, _1: _p1.editPhotos};
	switch (_p2._0.ctor) {
		case 'MixesRoute':
			return _user$project$Views_Mixes$view(_p3);
		case 'MixRoute':
			if (_p2._1 === false) {
				return _user$project$Views_Channels$view(_p3);
			} else {
				return _user$project$Views_ManageChannels$view(_p3);
			}
		default:
			return A2(
				_elm_lang$html$Html$div,
	...
	var _p4 = function () {
		...
		if (_p5.ctor === 'Just') {
			return {
				...
				_1: {
					ctor: '::',
					_0: _user$project$View$editPhotosNavidation,
					_1: {ctor: '[]'}
				}
			};
		} else {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Router$gotoMixes),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'background', 'url(\'/assets/bbh.png\') center / cover'),
										_1: {
											ctor: '::',
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$downs(_user$project$Msgs$KeyMsg);
};
var _user$project$Main$init = function (location) {
	...
	switch (_p0.ctor) {
		case 'MixesRoute':
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				A2(_user$project$Models$initialModel, currentRoute, _elm_lang$core$Maybe$Nothing),
				{
					ctor: '::',
					_0: _user$project$Commands$fetchMixes,
					_1: {ctor: '[]'}
				});
		case 'MixRoute':
			var _p1 = _p0._0;
			return A2(
					...
					_elm_lang$core$Maybe$Just(_p1)),
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Commands$fetchChannels(_p1),
						_1: {ctor: '[]'}
					}
				});
		default:
